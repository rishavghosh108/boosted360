          ...
          <div className="w-full lg:w-2/5 md:w-3/5 mx-auto">
            <div className="message-box bg-white shadow-lg py-10 px-5 text-center border-b-4 border-solid border-[#45a6ff]">
              <div className="flex items-center justify-center mb-5">
                <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="#ef4444" className="bi bi-x-circle-fill" viewBox="0 0 16 16">
              ...
              <Link href='/boosted360/#packages'>
                  <button className='mt-3 w-md bg-white border-2 border-green-300 font-bold text-xl pl-5 pr-5 rounded-lg hover:bg-green-500 hover:text-white'>Retry</button>
              </Link>
            </div>
          </div>
        </div>
