...
import { BgGrain, IserviceBannerOne, Servicebg, ServiceIconone, ServiceIcontwo, ServiceIconthree, downArrow,AudienceResearch, Content_Creation_Distribution, SEOOptimization, Ongoing_Monitoring_Adjustment } from "../../assets/index";
...
const Page = () => {
    ...
    const services = [
        {
            ...
            image: "/images/content-marketing/content-marketing-bottom1.png",
        },
        {
            id: 2,
            ...
            image: "/images/content-marketing/content-marketing-bottom2.png",
        },
        {
            id: 3,
            ...
            image: "/images/content-marketing/content-marketing-bottom3.png",
        },
        {
            id: 4,
            ...
            image: "/images/content-marketing/content-marketing-bottom4.png",
        },
    ];
    ...
    return (
        <Layouts>
            <title>Content Marketing Agency | Content Marketing Services</title>
            <meta name="title" content='Content Marketing Agency | Content Marketing Services' />
                ...
                <div className="container">
                    <div className="bg-cover bg-center rounded-[10px] py-[40px] md:px-10 px-5" style={{ backgroundImage: `url(${Servicebg.src})`, }}>
                        ...
                        <div className='space-y-3 mt-10'>
                            ...
                            <div className='bg-[#292929] bg-opacity-80 p-5 rounded-lg flex'>
                                <div className='shrink-0 lg:size-32 md:size-20 size-10'>
                                    <Image src={Content_Creation_Distribution} alt='Service-Icon-one' className="max-h-[100px] m-auto" />
                                </div>
                                <div className='pl-5'>
