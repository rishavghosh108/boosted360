                ...
                <div className='container'>
                    <div className='grid sm:grid-cols-2 grid-cols-1 items-start'>
                        <div className="sm:order-none order-2 md:mt-0 mt-5">
                            <h1 className='text-3xl lg:text-4xl xl:text-5xl font-bold text-black leading-none'>Reputation Management Company: <span className='text-[#5db947]'>Protect and Enhance Your Brand&apos;s Image</span></h1>
                            <p className='text-lg lg:text-xl font-medium text-black leading-[1.6] pt-5 lg:pt-6'>At our <strong>reputation management company</strong>, we specialize in providing comprehensive reputation management solutions that protect and improve your online presence. Whether you&apos;re dealing with negative reviews or aiming to strengthen your online image, our team helps safeguard and enhance your brand’s reputation through strategic <strong>online reputation management services</strong>.</p>
                ...
                <div className='container'>
                    <div className='flex flex-wrap'>
                        <div className='w-full mb-6'>
                            ...
                            <h3 className='text-3xl lg:text-[56px] xl:text-[65px] font-bold text-black leading-none'>Why Choose Online Reputation Management Service?</h3>
                        </div>
                        ...
                        <div className='md:w-2/3 w-full md:mt-0 mt-4 pt-6'>
                            <p className='text-lg lg:text-xl font-light text-black leading-[1.6]'>Our <strong>online reputation management service</strong> is designed to help businesses proactively manage their online presence and quickly address negative feedback. Whether it’s through search engine results, social media, or review platforms, our reputation management services ensure that your brand is seen in the best light.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="bg-cover bg-center rounded-[10px] py-[40px] md:px-10 px-5" style={{ backgroundImage: `url(${Servicebg.src})`, }}>
                        <div>
                            ...
                            <p className="text-base lg:text-lg px-[10px] text-[#bcbcbc] leading-[1.6] text-center">
                                Our <strong>reputation management company</strong> focuses on delivering measurable results by implementing effective strategies tailored to your business needs.
                            </p>
                        </div>
                        <div className='space-y-3 mt-10'>
                            <div className='bg-[#292929] bg-opacity-80 p-5 rounded-lg flex'>
                                ...
                                <div className='pl-5'>
                                    ...
                                    <p className='text-base font-light lg:text-lg text-[#bcbcbc] leading-[1.6]'>We begin by conducting a thorough audit of your online reputation, analyzing both positive and negative content. This allows us to create a strategy that targets areas of concern while enhancing your strengths.</p>
                                </div>
                            </div>
                            <div className='bg-[#292929] bg-opacity-80 p-5 rounded-lg flex'>
                                <div className='shrink-0 lg:size-32 md:size-20 size-10'>
                                ...
                                <div className='pl-5'>
                                    ...
                                    <p className='text-base font-light lg:text-lg text-[#bcbcbc] leading-[1.6]'>Our team develops a customized reputation management strategy that includes content creation, search engine optimization <strong>(SEO reputation management)</strong>, and the removal or suppression of negative content to improve your online image.</p>
                                </div>
                            </div>
                            <div className='bg-[#292929] bg-opacity-80 p-5 rounded-lg flex'>
                                <div className='shrink-0 lg:size-32 md:size-20 size-10'>
                                ...
                                <div className='pl-5'>
                                    ...
                                    <p className='text-base font-light lg:text-lg text-[#bcbcbc] leading-[1.6]'>We actively manage and monitor your social media channels to ensure that any potential issues are addressed promptly, enhancing your social media presence and protecting your reputation across platforms.</p>
                                </div>
                            </div>
                            <div className='bg-[#292929] bg-opacity-80 p-5 rounded-lg flex'>
                                <div className='shrink-0 lg:size-32 md:size-20 size-10'>
                                ...
                                <div className='pl-5'>
                                    ...
                                    <p className='text-base font-light lg:text-lg text-[#bcbcbc] leading-[1.6]'>Once your reputation management plan is in motion, we continually monitor your online presence and make data-driven adjustments. This ensures long-term, sustainable brand health.</p>
                                </div>
                            </div>
                                ...
                                <div className="sm:flex flex-wrap items-center">
                                    <div className="sm:w-6/12 w-full sm:pr-8">
                                        ...
                                        <div className="md:mt-5 mt-4">
                                            <p className="text-xl lg:text-3xl font-bold text-black leading-[1.6] mb-1">Improved Online Reputation</p>
                            ...
                            {activeTab === "tab2" &&
                                <div className="sm:flex flex-wrap items-center">
                                    <div className="sm:w-6/12 w-full sm:pr-8">
                                        ...
                                        <div className="md:mt-5 mt-4">
                                            <p className="text-xl lg:text-3xl font-bold text-black leading-[1.6] mb-1">Enhanced Search Engine Results</p>
                            ...
                            {activeTab === "tab3" &&
                                <div className="sm:flex flex-wrap items-center">
                                    <div className="sm:w-6/12 w-full sm:pr-8">
                                        ...
                                        <div className="md:mt-5 mt-4">
                                            <p className="text-xl lg:text-3xl font-bold text-black leading-[1.6] mb-1">Better Customer Trust & Engagement</p>
                            ...
                            {activeTab === "tab4" &&
                                <div className="sm:flex flex-wrap items-center">
                                    <div className="sm:w-6/12 w-full sm:pr-8">
                                        ...
                                        <div className="md:mt-5 mt-4">
                                            <p className="text-xl lg:text-3xl font-bold text-black leading-[1.6] mb-1">Sustained Brand Growth</p>
