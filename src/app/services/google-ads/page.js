...
import { BgGrain, IserviceBannerOne, Servicebg, ServiceIconone, ServiceIcontwo, ServiceIconthree, downArrow, AudienceResearch, CampaignCreationOptimization, googleadsmanagement,Reporting_Analytics, AudienceResearch_Insights } from "../../assets/index";
                ...
                <div className='container'>
                    <div className='flex flex-wrap'>
                        ...
                        <div className='md:w-2/3 w-full md:mt-0 mt-4 pt-6'>
                            <p className='text-lg lg:text-xl font-light text-black leading-[1.6]'>Our <strong>Google ads services</strong> are crafted to ensure your business reaches the right audience at the right time. By leveraging Google&apos;s vast advertising network, we help you target specific demographics and keywords that align with your business needs. Our Google ads specialists focus on driving qualified traffic, enhancing conversion rates, and boosting ROI.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="bg-cover bg-center rounded-[10px] py-[40px] md:px-10 px-5" style={{ backgroundImage: `url(${Servicebg.src})`, }}>
                        <div>
                            ...
                            <p className="text-base lg:text-lg px-[10px] text-[#bcbcbc] leading-[1.6] text-center">
                                As a leading <strong>Google ads agency,</strong> we implement a strategic, data-driven approach to maximize the effectiveness of your campaigns.
                            </p>
                        </div>
                        <div className='space-y-3 mt-10'>
                            <div className='bg-[#292929] bg-opacity-80 p-5 rounded-lg flex'>
                                <div className='shrink-0 lg:size-32 md:size-20 size-10'>
                                    <Image src={AudienceResearch} alt='Service-Icon-one' className="max-h-[100px] m-auto" />
                                </div>
                                <div className='pl-5'>
                                    <h3 className='text-xl lg:text-2xl font-semibold text-white leading-[1.6] mb-1'>Audience Research & Strategy</h3>
                                    <p className='text-base font-light lg:text-lg text-[#bcbcbc] leading-[1.6]'>We begin by identifying your target audience, understanding their needs, and studying their behavior. This helps us develop a targeted strategy tailored to your business goals, ensuring your Google ads campaigns reach the right people.</p>
                                </div>
                            </div>
                            <div className='bg-[#292929] bg-opacity-80 p-5 rounded-lg flex'>
                                <div className='shrink-0 lg:size-32 md:size-20 size-10'>
                                    <Image src={CampaignCreationOptimization} alt='Service-Icon-one' className="max-h-[100px] m-auto" />
                                </div>
                                <div className='pl-5'>
                                    <h3 className='text-xl lg:text-2xl font-semibold text-white leading-[1.6] mb-1'>Campaign Creation & Optimization
                                    </h3>
                                    <p className='text-base font-light lg:text-lg text-[#bcbcbc] leading-[1.6]'>Our <strong>Google advertising agency</strong> creates highly engaging ad copy and sets up campaigns that are optimized for maximum performance. We continually test and refine your ads to improve CTR (click-through rate) and conversion rates, ensuring your business stands out.</p>
                                </div>
                            </div>
                            <div className='bg-[#292929] bg-opacity-80 p-5 rounded-lg flex'>
                                <div className='shrink-0 lg:size-32 md:size-20 size-10'>
                                    <Image src={googleadsmanagement} alt='Service-Icon-one' className="max-h-[100px] m-auto" />
                                </div>
                                <div className='pl-5'>
                                    <h3 className='text-xl lg:text-2xl font-semibold text-white leading-[1.6] mb-1'>Google Ads Management</h3>
                                    <p className='text-base font-light lg:text-lg text-[#bcbcbc] leading-[1.6]'>As experienced <strong>Google ads consultants,</strong> we provide hands-on management of your campaigns, monitoring key performance metrics to adjust bids, keywords, and targeting as necessary. We use advanced tools to track and optimize your campaigns, helping you get the most out of your Google PPC services.</p>
                                </div>
                            </div>
                            <div className='bg-[#292929] bg-opacity-80 p-5 rounded-lg flex'>
                                <div className='shrink-0 lg:size-32 md:size-20 size-10'>
                                    <Image src={Reporting_Analytics} alt='Service-Icon-one' className="max-h-[100px] m-auto" />
                                </div>
                                <div className='pl-5'>
                                    <h3 className='text-xl lg:text-2xl font-semibold text-white leading-[1.6] mb-1'>Reporting & Analytics</h3>
                                    <p className='text-base font-light lg:text-lg text-[#bcbcbc] leading-[1.6]'>We provide clear and transparent reporting, showing how your <strong>Google PPC services</strong> are performing. Through regular analysis and performance insights, we continuously refine your campaigns to drive even better results.</p>
                                </div>
                            </div>
                            {/* <div className='bg-[#292929] bg-opacity-80 p-5 rounded-lg flex'>
                                <div className='shrink-0 lg:size-32 md:size-20 size-10'>
                                ...
                                <div className="sm:flex flex-wrap items-center">
                                    <div className="sm:w-6/12 w-full sm:pr-8">
                                        ...
                                        <div className="md:mt-5 mt-4">
                                            <p className="text-xl lg:text-3xl font-bold text-black leading-[1.6] mb-1">Increased Website Traffic</p>
                                            <p className="text-sm font-light lg:text-lg text-neutral-600 leading-[1.6]">By targeting the right keywords and audience segments, we help drive more relevant traffic to your website, leading to higher engagement.</p>
                                        </div>
                                    </div>
                            ...
                            {activeTab === "tab2" &&
                                <div className="sm:flex flex-wrap items-center">
                                    <div className="sm:w-6/12 w-full sm:pr-8">
                                        ...
                                        <div className="md:mt-5 mt-4">
                                            <p className="text-xl lg:text-3xl font-bold text-black leading-[1.6] mb-1">Higher Conversion Rates
                                            </p>
                                            <p className="text-sm font-light lg:text-lg text-neutral-600 leading-[1.6]">Our expert Google ads marketing strategies ensure that your ads not only reach the right people but also prompt them to take action, whether it’s making a purchase, signing up, or filling out a contact form.</p>
                                        </div>
                                    </div>
                                    <div className='relative before:w-full before:block before:pt-[62.5%] sm:w-5/12 w-full sm:mt-0 mt-4'>
                            ...
                            {activeTab === "tab3" &&
                                <div className="sm:flex flex-wrap items-center">
                                    <div className="sm:w-6/12 w-full sm:pr-8">
                                        ...
                                        <div className="md:mt-5 mt-4">
                                            <p className="text-xl lg:text-3xl font-bold text-black leading-[1.6] mb-1">Improved ROI</p>
                                            <p className="text-sm font-light lg:text-lg text-neutral-600 leading-[1.6]">Through careful optimization of your Google ads campaigns, we ensure that your investment is maximized, resulting in a higher return on investment and long-term business growth.</p>
                                        </div>
                                    </div>
                                    <div className='relative before:w-full before:block before:pt-[62.5%] sm:w-5/12 w-full sm:mt-0 mt-4'>
                            ...
                            {activeTab === "tab4" &&
                                <div className="sm:flex flex-wrap items-center">
                                    <div className="sm:w-6/12 w-full sm:pr-8">
                                        ...
                                        <div className="md:mt-5 mt-4">
                                            <p className="text-xl lg:text-3xl font-bold text-black leading-[1.6] mb-1">Brand Visibility & Recognition</p>
                                            <p className="text-sm font-light lg:text-lg text-neutral-600 leading-[1.6]">With our Google local ads services, we enhance your brand&apos;s visibility across Google&apos;s ad network, ensuring that potential customers can easily find your business when searching for relevant products or services.
                                            </p>
                                        </div>
                                    </div>
                                    <div className='relative before:w-full before:block before:pt-[62.5%] sm:w-5/12 w-full sm:mt-0 mt-4'>
