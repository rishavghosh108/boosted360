...
import { BgGrain, IserviceBannerOne, Servicebg, ServiceIconone, ServiceIcontwo, ServiceIconthree, downArrow, ServiceIconfour } from "../../assets/index";
...
const Page = () => {
    ...
    const services = [
        {
            id: 1,
            title: "Expert Local SEO Knowledge",
            description: "With years of experience in local SEO, our experts understand the nuances of local search and tailor strategies that deliver results in your market.",
            image: "/images/localseo/whychooseus/Expert_Local_SEO_Knowledge.jpg",
        },
        {
            id: 2,
            title: "Proven Track Record",
            description: "We’ve successfully helped countless businesses improve their local search rankings, increase visibility, and drive local traffic, giving us a solid reputation as a trusted local SEO agency.",
            image: "/images/localseo/whychooseus/Proven_Track_Record.jpg",
        },
        {
            id: 3,
            title: "Comprehensive Tools & Resources",
            description: "We use advanced SEO tools and techniques to perform detailed audits, optimize your site, and ensure the best possible results for local SEO campaigns.",
            image: "/images/localseo/whychooseus/Comprehensive_Tools_Resources.jpg",
        },
        {
            id: 4,
            title: "Dedicated Customer Support",
            description: "Our local SEO company provides ongoing support and guidance to ensure your SEO efforts continue to thrive, helping your business stay competitive in the digital landscape.",
            image: "/images/localseo/whychooseus/Dedicated_Customer_Support.jpg",
        },
    ];
            ...
            <div className='pt-6 lg:pt-12 bg-no-repeat' style={{ backgroundImage: `url(${BgGrain.src})`, }}>
                <div className='container'>
                    <div className='grid sm:grid-cols-2 grid-cols-1 items-start'>
                        <div className="sm:order-none order-2 md:mt-0 mt-5 mr-0 sm:mr-8">
                            <h1 className='text-3xl lg:text-4xl xl:text-5xl font-bold text-black leading-none'>Local SEO Company: <span className='text-[#5db947]'>Boost Your Business Visibility</span></h1>
                            <p className='text-lg lg:text-xl font-medium text-black leading-[1.6] pt-5 lg:pt-6'>As a leading local SEO company, we offer tailored local SEO services to help your business rank higher in local searches. Our services are designed to connect you with potential customers nearby, driving foot traffic and local sales. </p>
                        ...
                        <div className='relative before:w-full before:block before:pt-[62.5%] sm:ml-3'>
                            <Image src={'/images/localseo/local_SEO_company.jpg'} alt="arrow" width="610" height="650" className='size-full absolute top-0 right-0 bottom-0 left-0 object-cover' />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className='container'>
                    <div className='flex flex-wrap'>
                        ...
                        <div className='md:w-2/3 w-full md:mt-0 mt-4 pt-6'>
                            <p className='text-lg lg:text-xl font-light text-black leading-[1.6]'>Local SEO services are crucial for businesses looking to dominate their local market. With our local SEO services for small businesses, we ensure your business gets noticed by local customers who are actively searching for services you offer. This targeted approach increases your online visibility, attracts more customers, and helps you outshine competitors in your area.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="bg-cover bg-center rounded-[10px] py-[40px] md:px-10 px-5" style={{ backgroundImage: `url(${Servicebg.src})`, }}>
                        <div>
                            ...
                            <p className="text-base lg:text-lg px-[10px] text-[#bcbcbc] leading-[1.6] text-center">
                                Our proven SEO for local businesses focuses on strategies that deliver measurable results and help local businesses thrive in the digital world. Here&apos;s how we approach each project:
                            </p>
                        </div>
                        <div className='space-y-3 mt-10'>
                            <div className='bg-[#292929] bg-opacity-80 p-5 rounded-lg flex'>
                                ...
                                <div className='pl-5'>
                                    ...
                                    <p className='text-base font-light lg:text-lg text-[#bcbcbc] leading-[1.6]'>We conduct a comprehensive analysis of your business, target audience, and competitors, ensuring we understand your unique needs and challenges for local SEO success.</p>
                                </div>
                            </div>
                            <div className='bg-[#292929] bg-opacity-80 p-5 rounded-lg flex'>
                                <div className='shrink-0 lg:size-32 md:size-20 size-10'>
                                ...
                                <div className='pl-5'>
                                    ...
                                    <p className='text-base font-light lg:text-lg text-[#bcbcbc] leading-[1.6]'>Based on our research, our GMB optimization agency develops a customized plan that addresses key local SEO elements like Google My Business (GMB) optimization, local keywords, and local citations to boost visibility.</p>
                                </div>
                            </div>
                            <div className='bg-[#292929] bg-opacity-80 p-5 rounded-lg flex'>
                                <div className='shrink-0 lg:size-32 md:size-20 size-10'>
                                ...
                                <div className='pl-5'>
                                    ...
                                    <p className='text-base font-light lg:text-lg text-[#bcbcbc] leading-[1.6]'>We implement the strategy, ensuring your website is optimized for local search engines. We continuously monitor performance and refine tactics for maximum impact and results.</p>
                                </div>
                            </div>
                            <div className='bg-[#292929] bg-opacity-80 p-5 rounded-lg flex'>
                                <div className='shrink-0 lg:size-32 md:size-20 size-10'>
                                    <Image src={ServiceIconfour} alt='Service-Icon-one' className="max-h-[100px] m-auto" />
                                </div>
                                <div className='pl-5'>
                                    <h3 className='text-xl lg:text-2xl font-semibold text-white leading-[1.6] mb-1'>Reporting & Insights</h3>
                                    <p className='text-base font-light lg:text-lg text-[#bcbcbc] leading-[1.6]'>We provide transparent reports that track your business&apos;s local SEO performance, offering insights to refine and optimize future strategies for ongoing growth.</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="sm:flex flex-wrap items-center">
                                    <div className="sm:w-6/12 w-full sm:pr-8">
                                        ...
                                        <div className="md:mt-5 mt-4">
                                            ...
                                            <p className="text-sm font-light lg:text-lg text-neutral-600 leading-[1.6]">By focusing on local SEO, we drive more organic traffic to your website from users in your area, leading to more qualified leads and increased opportunities for conversions.</p>
                                        </div>
                                    </div>
                                    <div className='relative before:w-full before:block before:pt-[62.5%] sm:ml-3 sm:w-5/12 w-full sm:mt-0 mt-4'>
                                        <Image src={'/images/localseo/Increased_Organic_Traffic.jpg'} width="610" height="650" className='size-full absolute top-0 right-0 bottom-0 left-0 object-cover' alt="arrow" />
                                    </div>
                                </div>
                            }
                            {activeTab === "tab2" &&
                                <div className="sm:flex flex-wrap items-center">
                                    <div className="sm:w-6/12 w-full sm:pr-8">
                                        ...
                                        <div className="md:mt-5 mt-4">
                                            ...
                                            <p className="text-sm font-light lg:text-lg text-neutral-600 leading-[1.6]">Targeting local customers helps increase your chances of conversion, as visitors are more likely to take action when they find relevant, location-based information.</p>
                                        </div>
                                    </div>
                                    <div className='relative before:w-full before:block before:pt-[62.5%] sm:ml-3 sm:w-5/12 w-full sm:mt-0 mt-4'>
                                        <Image src={'/images/localseo/Higher_Conversion_Rates.jpg'} width="610" height="650" className='size-full absolute top-0 right-0 bottom-0 left-0 object-cover' alt="arrow" />
                                    </div>
                                </div>
                            }
                            {activeTab === "tab3" &&
                                <div className="sm:flex flex-wrap items-center">
                                    <div className="sm:w-6/12 w-full sm:pr-8">
                                        ...
                                        <div className="md:mt-5 mt-4">
                                            ...
                                            <p className="text-sm font-light lg:text-lg text-neutral-600 leading-[1.6]">Through strategic local SEO practices, your business gains greater visibility within your community, strengthening brand recognition and trust among local customers.</p>
                                        </div>
                                    </div>
                                    <div className='relative before:w-full before:block before:pt-[62.5%] sm:ml-3 sm:w-5/12 w-full sm:mt-0 mt-4'>
                                        <Image src={'/images/localseo/Improved_Brand_Awareness.jpg'} width="610" height="650" className='size-full absolute top-0 right-0 bottom-0 left-0 object-cover' alt="arrow" />
                                    </div>
                                </div>
                            }
                            {activeTab === "tab4" &&
                                <div className="sm:flex flex-wrap items-center">
                                    <div className="sm:w-6/12 w-full sm:pr-8">
                                        ...
                                        <div className="md:mt-5 mt-4">
                                            ...
                                            <p className="text-sm font-light lg:text-lg text-neutral-600 leading-[1.6]">Investing in local SEO leads to sustainable, long-term results. As your online presence improves, your business enjoys continued ROI through consistent local traffic and customer engagement.</p>
                                        </div>
                                    </div>
                                    <div className='relative before:w-full before:block before:pt-[62.5%] sm:ml-3 sm:w-5/12 w-full sm:mt-0 mt-4'>
                                        <Image src={'/images/localseo/Long_Term_ROI.jpg'} width="610" height="650" className='size-full absolute top-0 right-0 bottom-0 left-0 object-cover' alt="arrow" />
                                    </div>
                                </div>
                            }
                            {activeTab === "tab5" &&
                                <div className="sm:flex flex-wrap items-center">
                                    <div className="sm:w-6/12 w-full sm:pr-8">
                                        ...
                                        <div className="md:mt-5 mt-4">
                                            ...
                                            <p className="text-sm font-light lg:text-lg text-neutral-600 leading-[1.6]">Our local SEO experts help generate quality leads by ensuring your business appears in front of the right local audience, turning visitors into loyal customers.</p>
                                        </div>
                                    </div>
                                    <div className='relative before:w-full before:block before:pt-[62.5%] sm:ml-3 sm:w-5/12 w-full sm:mt-0 mt-4'>
                                        <Image src={'/images/localseo/Lead_Generation.jpg'} width="610" height="650" className='size-full absolute top-0 right-0 bottom-0 left-0 object-cover' alt="arrow" />
                                    </div>
                                </div>
                            }
                        </div>
