...
import { BgGrain, IserviceBannerOne, Servicebg, ServiceIconone, ServiceIcontwo, ServiceIconthree, downArrow, TargetAudienceResearch, Campaign_Strategy_Setup, ContinuousOptimization_Management, ReportingPerformanceTracking} from "../../assets/index";
                ...
                <div className='container'>
                    <div className='grid sm:grid-cols-2 grid-cols-1 items-start'>
                        <div className="sm:order-none order-2 md:mt-0 mt-5">
                            <h1 className='text-3xl lg:text-4xl xl:text-5xl font-bold text-black leading-none'>Email Marketing Agency: <span className='text-[#5db947]'>Get More Leads Today</span></h1>
                            <p className='text-lg lg:text-xl font-medium text-black leading-[1.6] pt-5 lg:pt-6'>At our <strong>email marketing agency</strong>, we specialize in providing comprehensive services that drive engagement, conversions, and growth. Whether you&apos;re looking to reach new customers or engage with your existing audience, our team helps maximize the effectiveness of your email campaigns through strategic <strong>email marketing solutions</strong>.</p>
                ...
                <div className='container'>
                    <div className='flex flex-wrap'>
                        <div className='w-full mb-6'>
                            ...
                            <h3 className='text-3xl lg:text-[56px] xl:text-[65px] font-bold text-black leading-none'>Why Choose Email Marketing Services?</h3>
                        </div>
                        ...
                        <div className='md:w-2/3 w-full md:mt-0 mt-4 pt-6'>
                            <p className='text-lg lg:text-xl font-light text-black leading-[1.6]'>With millions of businesses leveraging email to reach customers daily, it&apos;s essential to have a targeted approach that ensures your messages stand out. Our <strong>email marketing services</strong> are designed to help you engage your audience effectively, optimize open rates, and drive conversions.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="bg-cover bg-center rounded-[10px] py-[40px] md:px-10 px-5" style={{ backgroundImage: `url(${Servicebg.src})`, }}>
                        <div>
                            ...
                            <p className="text-base lg:text-lg px-[10px] text-[#bcbcbc] leading-[1.6] text-center">
                                Our <strong>email marketing agency</strong> focuses on delivering results by crafting personalized and effective email marketing strategies for every business.
                            </p>
                        </div>
                        <div className='space-y-3 mt-10'>
                            <div className='bg-[#292929] bg-opacity-80 p-5 rounded-lg flex'>
                                <div className='shrink-0 lg:size-32 md:size-20 size-10'>
                                    <Image src={TargetAudienceResearch} alt='Service-Icon-one' className="max-h-[100px] m-auto" />
                                </div>
                                <div className='pl-5'>
                                    <h3 className='text-xl lg:text-2xl font-semibold text-white leading-[1.6] mb-1'>Target Audience Research</h3>
                                    <p className='text-base font-light lg:text-lg text-[#bcbcbc] leading-[1.6]'>We begin by understanding your target audience, their preferences, and behaviors. This allows us to design campaigns that speak directly to their interests and needs.</p>
                                </div>
                            </div>
                            <div className='bg-[#292929] bg-opacity-80 p-5 rounded-lg flex'>
                                <div className='shrink-0 lg:size-32 md:size-20 size-10'>
                                ...
                                <div className='pl-5'>
                                    ...
                                    <p className='text-base font-light lg:text-lg text-[#bcbcbc] leading-[1.6]'>Our ecommerce email marketing agency develops a robust email marketing strategy that includes list segmentation, personalized content, and optimization for higher engagement and conversions. We ensure your emails reach the right people at the right time. </p>
                                </div>
                            </div>
                            <div className='bg-[#292929] bg-opacity-80 p-5 rounded-lg flex'>
                                <div className='shrink-0 lg:size-32 md:size-20 size-10'>
                                ...
                                <div className='pl-5'>
                                    ...
                                    <p className='text-base font-light lg:text-lg text-[#bcbcbc] leading-[1.6]'>Once your campaigns are live, we continually analyze their performance, fine-tuning content, subject lines, and call-to-action buttons to maximize open rates and conversions.</p>
                                </div>
                            </div>
                            <div className='bg-[#292929] bg-opacity-80 p-5 rounded-lg flex'>
                                <div className='shrink-0 lg:size-32 md:size-20 size-10'>
                                ...
                                <div className='pl-5'>
                                    ...
                                    <p className='text-base font-light lg:text-lg text-[#bcbcbc] leading-[1.6]'>Detailed reports allow you to monitor your campaigns’ success. We provide insights that help you improve your email marketing efforts, ensuring better ROI.</p>
                                </div>
                            </div>
                                ...
                                <div className="sm:flex flex-wrap items-center">
                                    <div className="sm:w-6/12 w-full sm:pr-8">
                                        ...
                                        <div className="md:mt-5 mt-4">
                                            <p className="text-xl lg:text-3xl font-bold text-black leading-[1.6] mb-1">Increased Engagement</p>
                            ...
                            {activeTab === "tab3" &&
                                <div className="sm:flex flex-wrap items-center">
                                    <div className="sm:w-6/12 w-full sm:pr-8">
                                        ...
                                        <div className="md:mt-5 mt-4">
                                            <p className="text-xl lg:text-3xl font-bold text-black leading-[1.6] mb-1">Optimized Campaign Spend</p>
