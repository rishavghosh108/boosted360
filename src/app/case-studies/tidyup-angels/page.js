        ...
        <Layouts>
            <div className='container'>
                <div className='grid lg:grid-cols-2 gap-8 items-center pt-5 lg:pb-20 pb-10'>
                    ...
                    <div className=''>
                        <Image src={work5} className='max-w-3xl mx-auto w-full h-96 object-contain' alt={`Slide`} />
                    </div>
                </div>
            </div>
