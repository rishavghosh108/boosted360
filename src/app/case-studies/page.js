                ...
                <div className='container'>
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-[18px] sm:gap-[25px] lg:px-0 px-0 sm:px-10 nn1:px-[15%]'>
                        {SlideItems.map((item, index) => (
                            <div key={index} className='bg-blue-950 h-[188px] sm:h-[300px] md:h-[360px] lg:h-[310px] xl:h-[350px] hover:shadow-md rounded-xl overflow-hidden relative group'>
                                <div className='w-[48%] rounded-xl p-2 sm:p-5 xl:p-6 text-white text-left h-full flex flex-col justify-center'>
                                ...
                                <Link class="absolute size-[2rem] sm:size-14 left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 scale-0 group-hover:scale-100 transition-all duration-300 ease-in-out rounded-full bg-white flex items-center justify-center z-[9] shadow-lg" href="#">
